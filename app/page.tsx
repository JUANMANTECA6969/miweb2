...
export default function Page() {
  return (
    <main className="relative h-screen overflow-hidden">
      ...
      <div className="h-screen w-full bg-transparent flex items-center justify-center px-12">
        <div className="h-full w-full bg-transparent shadow-2xl flex items-center justify-center">
          <p
